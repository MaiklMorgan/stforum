...
/* forumlist_body.html */
class __TwigTemplate_6e4bf15de19dc32627337945718622d4045f3609adf0a312a4c6e1ed60278d41 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["forumrow"], "S_ROW_COUNT", [], "any", false, false, false, 50) == 1)) {
                    // line 51
                    echo "<br /><style>#silkpl { display: none; } </style><a href=\"https://silk.pl/jedwabne-poszewki-na-poduszki/\" id=\"silkpl\">silk.pl silk pillowcases</a>
";
                }
                // line 53
